...
echo "set title 'Fitness|opérateur / Génération'" >> gnuplot_script
echo "set xlabel 'Génération'" >> gnuplot_script
echo "set ylabel 'Fitness/Opérateur'" >> gnuplot_script
...
echo "plot 'data2.dat' u 1:2 title'1-flip' w l lw 2, 'data2.dat' u 1:3 title'bit-flip' w l lw 2, 'data2.dat' u 1:4 title'3-flip' w l lw 2, 'data2.dat' u 1:5 title'5-flip' w l lw 2" >> gnuplot_script
