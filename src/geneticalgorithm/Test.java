...
public class Test {	
	...
	public static final String CS = "croisementSimple"; //l'enfant va prendre soit les genes du parent1 soit ceux parent2
	...
	public static final int TAILLE_INDIVIDU = 700;
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		while (nb_execution < NB_EXECUTION) {
			Bandit.launch(selection, croisement, remplacement, historiqueOp, historiqueFitnessMin, historiqueFitnessMoy, historiqueFitnessMax, C, nb_execution, AOS);
			nb_execution++;
		}
		...
		while (nb_exec < NB_EXECUTION) {
			ClassicAG.launch(nb_exec, selection, croisement, mutation, remplacement, historiqueFitnessMinAGC, historiqueFitnessMoyAGC, historiqueFitnessMaxAGC);
			nb_exec++;
		}
