...
public class ClassicAG {
	 ...
	 */
	public static void launch(int NB_EXECUTION, String selection, String croisement, String mutation,
			String remplacement, ArrayList<Double> historiqueFitnessMin, ArrayList<Double> historiqueFitnessMoy,
			ArrayList<Double> historiqueFitnessMax)
