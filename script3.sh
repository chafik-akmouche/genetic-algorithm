...
echo "set title 'Courbe - Nombre d utilisation des operateurs / Generation'" >> gnuplot_script
echo "set xlabel 'Génération'" >> gnuplot_script
echo "set ylabel 'Moyenne d utilisation par operateur'" >> gnuplot_script
...
echo "plot 'data3.dat' u 1:2 title'1-flip' w l, 'data3.dat' u 1:3 title'bit-flip' w l, 'data3.dat' u 1:4 title'3-flip' w l, 'data3.dat' u 1:5 title'5-flip' w l" >> gnuplot_script
